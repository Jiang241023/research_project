...
from grit_like_framework.loss.subtoken_prediction_loss import subtoken_cross_entropy
from grit_like_framework.utils import cfg_to_dict, flatten_dict, make_wandb_name, mlflow_log_cfgdict
import warnings
...
def log_attn_weights(loggers, loaders, model, optimizer=None, scheduler=None):
    ...
    from grit_like_framework.utils import unbatch, unbatch_edge_index
